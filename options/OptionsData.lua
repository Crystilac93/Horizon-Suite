...
local OptionCategories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "slider", name = L["Timer size"], desc = L["Font size for timer (8–32 px)."], dbKey = "mplusTimerSize", min = 8, max = 32, step = 1, get = function() return math.max(8, math.min(32, tonumber(getDB("mplusTimerSize", 12)) or 12)) end, set = function(v) setDB("mplusTimerSize", math.max(8, math.min(32, v))) end },
            ...
            { type = "slider", name = L["Progress size"], desc = L["Font size for enemy forces (8–32 px)."], dbKey = "mplusProgressSize", min = 8, max = 32, step = 1, get = function() return math.max(8, math.min(32, tonumber(getDB("mplusProgressSize", 11)) or 11)) end, set = function(v) setDB("mplusProgressSize", math.max(8, math.min(32, v))) end },
            ...
            { type = "slider", name = L["Affix size"], desc = L["Font size for affixes (8–32 px)."], dbKey = "mplusAffixSize", min = 8, max = 32, step = 1, get = function() return math.max(8, math.min(32, tonumber(getDB("mplusAffixSize", 10)) or 10)) end, set = function(v) setDB("mplusAffixSize", math.max(8, math.min(32, v))) end },
            ...
            { type = "slider", name = L["Boss size"], desc = L["Font size for boss names (8–32 px)."], dbKey = "mplusBossSize", min = 8, max = 32, step = 1, get = function() return math.max(8, math.min(32, tonumber(getDB("mplusBossSize", 11)) or 11)) end, set = function(v) setDB("mplusBossSize", math.max(8, math.min(32, v))) end },
