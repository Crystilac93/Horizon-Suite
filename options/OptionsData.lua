...
local OptionCategories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "toggle", name = L["Show quality tier"], desc = L["Show quality tier indicator for recipes that support crafting qualities (e.g. Quality 1-3)."], dbKey = "showRecipeQualityInfo", get = function() return getDB("showRecipeQualityInfo", false) end, set = function(v) setDB("showRecipeQualityInfo", v) end },
