...
local OptionCategories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "toggle", name = L["Show recipes"], desc = L["Show tracked profession recipes in the list."], dbKey = "showRecipes", get = function() return getDB("showRecipes", true) end, set = function(v) setDB("showRecipes", v) end },
            { type = "toggle", name = L["Show recipe reagents"], desc = L["Show reagent shopping list (owned/required) for each tracked recipe. Includes a copy button to insert item links into chat."], dbKey = "showRecipeReagents", get = function() return getDB("showRecipeReagents", true) end, set = function(v) setDB("showRecipeReagents", v) end },
            { type = "section", name = L["Recipe reagent sections"] },
            { type = "toggle", name = L["Show optional reagents"], desc = L["Show optional (modifying) reagents in a collapsible section. When off, optional reagents are hidden."], dbKey = "showOptionalReagents", get = function() return getDB("showOptionalReagents", true) end, set = function(v) setDB("showOptionalReagents", v) end },
            { type = "toggle", name = L["Show finishing reagents"], desc = L["Show finishing reagents in a collapsible section. When off, finishing reagents are hidden."], dbKey = "showFinishingReagents", get = function() return getDB("showFinishingReagents", true) end, set = function(v) setDB("showFinishingReagents", v) end },
            { type = "toggle", name = L["Show choice slots"], desc = L["Show choice slots (e.g. \"1 of any\" Algari Missive) as collapsible sections. When off, choice slots are shown as a flat list of variants."], dbKey = "showChoiceSlots", get = function() return getDB("showChoiceSlots", true) end, set = function(v) setDB("showChoiceSlots", v) end },
            { type = "section", name = L["Recipe display"] },
            { type = "toggle", name = L["Show recipe icons"], desc = L["Show each recipe's icon next to the title. Requires 'Show quest type icons' in Display."], dbKey = "showRecipeIcons", get = function() return getDB("showRecipeIcons", true) end, set = function(v) setDB("showRecipeIcons", v) end },
            { type = "toggle", name = L["Color by item rarity"], desc = L["Color recipe names and reagents by their item quality (Poor, Common, Rare, Epic, etc.)."], dbKey = "recipeRarityColors", get = function() return getDB("recipeRarityColors", false) end, set = function(v) setDB("recipeRarityColors", v) end },
            { type = "toggle", name = L["Show craftable count"], desc = L["Show how many times you can craft this recipe with current reagents."], dbKey = "showCraftableCount", get = function() return getDB("showCraftableCount", false) end, set = function(v) setDB("showCraftableCount", v) end },
            { type = "toggle", name = L["Show quality tier"], desc = L["Show quality tier indicator for recipes that support crafting qualities (e.g. Quality: \226\152\133 \226\152\133 \226\152\133 1\226\128\1493)."], dbKey = "showRecipeQualityInfo", get = function() return getDB("showRecipeQualityInfo", false) end, set = function(v) setDB("showRecipeQualityInfo", v) end },
            { type = "toggle", name = L["Show unmet requirements"], desc = L["Show crafting station requirements when not met (e.g. 'Requires: Forge'). Hidden by default since these appear whenever you are away from a crafting station."], dbKey = "showRecipeRequirements", get = function() return getDB("showRecipeRequirements", false) end, set = function(v) setDB("showRecipeRequirements", v) end },
