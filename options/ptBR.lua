...
-- =====================================================================
L["Show recipes"]                                       = "Mostrar receitas"
L["Show tracked profession recipes in the list."]        = "Mostra receitas de profissão rastreadas na lista."
L["Show recipe reagents"]                               = "Mostrar reagentes de receitas"
L["Show reagent shopping list (owned/required) for each tracked recipe. Includes a copy button to insert item links into chat."] = "Mostra lista de compras de reagentes (possuídos/necessários) para cada receita rastreada. Inclui botão para copiar links de itens para o chat."
L["Recipe reagent sections"]                           = "Seções de reagentes"
L["Recipe display"]                                    = "Exibição de receitas"
L["Show optional reagents"]                             = "Mostrar reagentes opcionais"
L["Show optional (modifying) reagents in a collapsible section. When off, optional reagents are hidden."] = "Mostra reagentes opcionais (modificadores) em uma seção recolhível. Quando desativado, reagentes opcionais são ocultados."
L["Show finishing reagents"]                            = "Mostrar reagentes de acabamento"
L["Show finishing reagents in a collapsible section. When off, finishing reagents are hidden."] = "Mostra reagentes de acabamento em uma seção recolhível. Quando desativado, reagentes de acabamento são ocultados."
L["Show choice slots"]                                 = "Mostrar slots de escolha"
L["Show choice slots (e.g. \"1 of any\" Algari Missive) as collapsible sections. When off, choice slots are shown as a flat list of variants."] = "Mostra slots de escolha (ex.: \"1 de qualquer\" Missiva Algari) como seções recolhíveis. Quando desativado, mostra uma lista plana de variantes."
L["Copy to chat"]                                       = "Copiar para o chat"
L["Optional reagents"]                                  = "Reagentes opcionais"
L["Finishing reagents"]                                 = "Reagentes de acabamento"
L["Show recipe icons"]                                  = "Mostrar ícones de receitas"
L["Show each recipe's icon next to the title. Requires 'Show quest type icons' in Display."] = "Mostra o ícone de cada receita ao lado do título. Requer \"Mostrar ícones de tipo de missão\" em Exibição."
L["Color by item rarity"]                               = "Cor por raridade do item"
L["Color recipe names and reagents by their item quality (Poor, Common, Rare, Epic, etc.)."] = "Colore nomes de receitas e reagentes pela qualidade do item (Inferior, Comum, Raro, Épico, etc.)."
