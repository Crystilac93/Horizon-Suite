...
L["Font family for the progress bar label."]            = "진행 바 텍스트의 글꼴."
L["Progress bar text size"]                             = "진행 바 텍스트 크기"
L["Font size for the progress bar label. Also adjusts bar height."] = "진행 바 텍스트의 글꼴 크기. 바 높이도 함께 조정됩니다."
L["Progress bar fill"]                                  = "진행 바 채우기"
L["Progress bar text"]                                  = "진행 바 텍스트"
L["Outline"]                                            = "외곽선"
...
L["Show a visual hint when the list has more content than is visible."] = "목록에 보이는 것보다 더 많은 콘텐츠가 있을 때 시각적 힌트를 표시합니다."
L["Scroll indicator style"]                             = "스크롤 표시기 스타일"
L["Choose between a fade-out gradient or a small arrow to indicate scrollable content."] = "스크롤 가능한 콘텐츠를 나타내는 페이드 그라데이션 또는 작은 화살표 중 선택합니다."
L["Arrow"]                                              = "화살표"
